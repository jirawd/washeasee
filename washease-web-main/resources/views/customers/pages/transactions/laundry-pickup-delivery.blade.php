...
@section('content')
    ...
    <div class="alert alert-danger alert-dismissible text-bg-danger border-0 fade show d-none" id="alert_notification" role="alert">
                ...
                <div class="card">
                    <div class="card-body">
                            ...
                            <div class="col-sm-6">
                                <div class="float-end mt-3">
                                    ...
                                    <p class="text-muted fs-13">Please find below a cost-breakdown for the recent order
                                        you've selected.
                                        Please make payment at your earliest convenience, and do not hesitate to contact
                                        us
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="clearfix pt-3">
                                    <img src="{{ asset('customer_assets/images/GCASH-WASHEASE.png') }}" class="d-none" style="width: 400px;" id="gcash-payment" />
                                    <h6 class="text-muted fs-14">Payment Method:</h6>
                                    <select class="form-select" id="payment_method">
                                        <option value="CASH" selected>CASH</option>
                                        <option value="GCASH">GCASH</option>
                                    </select>
                                    <h6 class="text-muted fs-14 mt-2">Delivery Fee:</h6>
                                    <div>
                                        <div class="form-check">
                                            <input type="radio" id="customRadio1" name="delivery_fee"
                                                   class="form-check-input">
                                            <label class="form-check-label" for="customRadio1"> Standard Delivery
                                                ₱0.00</label>
                                        </div>
                                        <div class="form-check">
                                            <input type="radio" id="customRadio2" name="delivery_fee"
                                                   class="form-check-input">
                                            <label class="form-check-label" for="customRadio2"> Rush Delivery
                                                ₱200.00</label>
                                        </div>

                                        <div class="float-start mt-3">
                                            <p><b>VAT (12.5 / 12.5%):</b> <span class="float-end" id="vat_total">₱0.00</span>
                                            </p>
                        ...
                        <div class="d-print-none mt-4">
                            <div class="text-end">
                                <button id="send_order" href="javascript: void(0);" class="btn btn-soft-danger">Submit
                                </button>
                            </div>
                        </div>
                        <!-- end buttons -->
            ...
            function get_basic_services_by_laundry_shops(laundry_shop_id) {
                $.post(get_basic_services_by_laundry_shops_api, {
                    ...
                    washingMachines.forEach(function (machine) {
                        ...
                        const isDisabledButton = (machine.status === 'Not Available' || machine.status === 'Reserve') ? 'NOT AVAILABLE' : 'SELECT THIS MACHINE';
                        ...
                        <div class="col-md-3">
                            <div class="card border-secondary border">
                                <div class="card-body">
                                    ...
                                    <button data-washing_machine_id="${machine.id}" class="btn btn-purple btn-sm w-100 mt-2" ${isDisabled}>${isDisabledButton}</button>
                                </div>
                            </div>
                        </div>`;
                        // Append each card to the container
